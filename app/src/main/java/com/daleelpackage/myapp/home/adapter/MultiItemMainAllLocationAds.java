...
import com.daleelpackage.myapp.home.helper.MultiCustomLocationFilter;
...
//        (DiscreteScrollLayoutManager) recyclerView.getLayoutManager();
        ...
        holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(R.id.frameContainer, fragment_search).addToBackStack(null).commit();
            }
        });
    }
